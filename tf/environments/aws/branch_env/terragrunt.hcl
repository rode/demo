...
inputs = {
  ...
  harbor_host        = "harbor-${local.env_hash}.internal.lead.sandbox.liatr.io"
  harbor_insecure    = false
  harbor_cert_source = "none"

  enable_jenkins = true
  jenkins_host   = "jenkins-${local.env_hash}.internal.lead.sandbox.liatr.io"

  enable_nginx  = false
  ingress_class = "internal-nginx"

  elasticsearch_replicas = "3"
  rode_ui_host           = "rode-ui-${local.env_hash}.internal.lead.sandbox.liatr.io"
